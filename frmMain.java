...
public class frmMain extends javax.swing.JFrame {
    ...
    Hilo1 thread1 = new Hilo1();
    Hilo2 thread2 = new Hilo2();
    HIlo3 thread3 = new HIlo3();
    ...
    private void btnJugarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJugarActionPerformed
        try {
            ...
            thread2.run();
            thread3.run();
            whoIsThatPokemon1 = thread1.getPokemon();
            whoIsThatPokemon2 = thread2.getPokemon();
            whoIsThatPokemon3 = thread3.getPokemon();
